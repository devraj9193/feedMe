...
//
getInstance() {
  if (_pref!.getString(AppConfig.supabaseUserId) != null) {
    print(
        "_pref!.getString(AppConfig.QB_CURRENT_USERID): ${_pref!.getString(AppConfig.supabaseUserId)}");
    _localUserId =
        int.tryParse(_pref!.getString(AppConfig.supabaseUserId)!);
  }
}
//
// @override
...
Future<bool> getSession() async {
  bool? _isExpired;
  int? expiry = _pref!.getInt(AppConfig.getSupabaseSession);
  if (expiry != null) {
